...
class TestKassapaate(unittest.TestCase):
    ...
    def test_edullinen_maksu_ei_riita_kassa_sama(self):
        self.kassapaate.syo_edullisesti_kateisella(0)
        self.assertEqual(self.kassapaate.edulliset, 0)
        self.assertEqual(self.kassapaate.kassassa_rahaa, 100000)

    def test_kallis_maksu_ei_riita_kassa_sama(self):
        self.kassapaate.syo_edullisesti_kateisella(0)
        self.assertEqual(self.kassapaate.maukkaat, 0)
        self.assertEqual(self.kassapaate.kassassa_rahaa, 100000)

    #Tests that use Maksukortti
    def test_maksu_kortilla_veloittaa_ja_palauttaa(self):
    ...
    def test_maksu_kortilla_ei_veloittaa_jos_ei_tarpeeksi_rahaa(self):
